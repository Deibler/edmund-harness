/**
 * The icon set as inline SVG. Inline because every separate request would need
 * the share key appended, and an icon that fails to load is an invisible button.
 */
...
export const I = {
  ...
  /** Row actions: change it, or take it off. */
  ...
  /** Half of a cook-once-eat-twice pair: makes the leftovers, or eats them. */
  ...
  /** Other written variants of this dish exist. */
  ...
  /** Health score, on the household's own 0 to 5 scale. */
  ...
  /**
   * Cooked here before, with a written page behind it. A filled silhouette so
   * it reads at 18px on a photo.
   */
